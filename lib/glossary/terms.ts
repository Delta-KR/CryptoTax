...
export const GLOSSARY: readonly GlossaryTerm[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '한국 거주자의 가상자산 양도소득세는 총평균법만 인정돼요(시행령 §88①). 선입선출법은 비거주자나 참고용 계산에서만 써요.',
      '거래소 화면이 보여주는 선입선출 기준 손익과, 실제로 신고할 총평균법 손익은 다를 수 있어요. 신고는 총평균법 결과로 해야 해요.',
    ],
    law: '거주자 부적용 (시행령 §88① 총평균법만 인정)',
  ...
  },
  {
    ...
    body: [
      ...
      '가상자산은 총평균법으로 구한 평균 취득가액이 필요경비의 핵심이에요. 취득가액을 확인하기 어려우면 양도가액의 50%를 필요경비로 보는 의제 방식을 적용해요(이때 부대비용은 따로 더하지 않아요).',
    ],
    law: '소득세법 §37①3호 (취득가액 불분명 시 §37⑥·시행령 §88⑤, 양도가액의 50%)',
