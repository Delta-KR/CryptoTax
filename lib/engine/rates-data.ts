...
export const DAILY_RATES_FALLBACK: readonly StaticRateEntry[] = [
  ...
  // 자주 등장하는 수수료/거래 통화 fallback — DB 미적재 시 사용자에게 raw 에러
  // 노출 방지 (P1-9). 분기별 추정치, 정확도 낮으므로 DB 적재 후 재계산 권장 warning.
  ['2024-07-01', 'BNB', 'KRW', 700_000],
  ['2025-01-01', 'BNB', 'KRW', 1_000_000],
  ['2026-01-01', 'BNB', 'KRW', 950_000],
  ['2026-12-31', 'BNB', 'KRW', 1_000_000],
  ['2027-07-01', 'BNB', 'KRW', 1_100_000],
  ['2024-07-01', 'ETH', 'KRW', 4_500_000],
  ['2025-01-01', 'ETH', 'KRW', 5_500_000],
  ['2026-01-01', 'ETH', 'KRW', 5_200_000],
  ['2026-12-31', 'ETH', 'KRW', 5_000_000],
  ['2027-07-01', 'ETH', 'KRW', 5_500_000],
  ['2024-07-01', 'SOL', 'KRW', 200_000],
  ['2025-01-01', 'SOL', 'KRW', 280_000],
  ['2026-01-01', 'SOL', 'KRW', 300_000],
  ['2026-12-31', 'SOL', 'KRW', 300_000],
  ['2027-07-01', 'SOL', 'KRW', 350_000],
];
